...
## Last touched
2026-05-28 — второй проход: исправлены P-1, M-3, M-5, M-6, M-8, M-9, INFO-2 (поверх M-4/M-7);
M-10 отозван как не-баг после критического пересмотра; M-2/INFO-1 осознанно отложены.
**722 passed, 2 skipped.** Всё на ветке `audit/2026-05-28-hardening`, main НЕ трогался.
