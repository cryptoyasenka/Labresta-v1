...
**Last updated:** батч 5 (SKU 33-40, Robot Coupe диски 28111-28197 + комплекты дисков 1960/1961 для CL 50…CL 60) — все 8 blk триплет, авто-фиксы по locked-паттернам, подтверждения не требуется; soft-note 0; Открытых вопросов 0
