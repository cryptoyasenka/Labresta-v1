# chunk-080 cleanup wave2 batch 4 — SKU rows 25-32, all 16 columns
...
## r25 ART=2144730312 — SKIP-НП (brand=COLD)
- RU не переписывается, тело из НП-фида merge позже.

## r26 ART=2144737441 — SKIP-НП (brand=COLD)
- RU не переписывается, тело из НП-фида merge позже.

## r31 ART=2245896435 — SKIP-НП (brand=COLD)
- RU не переписывается, тело из НП-фида merge позже.
