# chunk-082 cleanup wave2 batch 5 — SKU rows 33-40, all 16 columns
...
## r36 ART=2052995590 — SKIP-НП (brand=COLD)
- RU не переписывается, тело из НП-фида merge позже.

## r37 ART=2133568246 — SKIP-НП (brand=COLD)
- RU не переписывается, тело из НП-фида merge позже.

## r39 ART=2219912908 — SKIP-НП (brand=FAGOR)
- RU не переписывается, тело из НП-фида merge позже.
