...
| 4 | ~~071~~ **021** | b5 SKU39 | (W1) | Один товар, канон `BCB10` (без NC). | **OUT OF W2 SCOPE** — chunk-021 = W1 диапазон (≤054). Snapshot ошибочно указывал «c071». Реальный источник OQ — `chunk-021-MANUAL-REVIEW.md` (commit `9f53ac8`). chunk-021.xlsx физически отсутствует в W2 worktree. | **FORWARD к W1: chunk-021 b5 SKU39** col5/col7 BCB10 NC → BCB10 (если есть NC); blknochg → blkfix; UA col4+col6 синхронно |
...
4. ~~`chunk-071-fixed.xlsx` SKU39~~ — **OUT OF SCOPE**: SKU реально в chunk-021 (W1 диапазон); forward к W1
...
**Forward к W1 (UA-правки + chunk-021 OQ#4):**
...
- **021 b5 SKU39 Bartscher**: канон BCB10 (без NC) — поправить col5/col7 RU и col4/col6 UA если есть NC; blknochg → blkfix
