...
## b6 (SKU 41-48, rows 42-49) — DONE 48/61

TRIP 6 + blknotrip 0 + blknochg 1 + SKIP-НП 1 = 8/8. Verify **229 PASS / 0 FAIL**.

**blknochg (1):**
- r42 SKU41 ART 646844867 PERS.PETROS (Orved) С254 камерный вакуумный упаковщик: c5==c7 RU OK, c36 RU OK без UA-mark; fixed НЕ изменена.

**TRIP (6):**
- r43 SKU42 ART 647420654 **Hendi Budget Line 975350** (планка 310 мм) безкамерный (c35==c36 UA dup, 696 chars): c5←c7 «Вакуумный упаковщик Hendi Budget Line 975350, планка 310 мм»; c36 ← RU body inline `<ul>` 11 li tech-char (2 цикла запаивания/рулон/310мм/2мм/попадание влаги/11л/мин/подъёмная крышка/комфорт/1,74кг/планка 310мм/390x160x92). Сохранены skel + dims `310/2/11/1,74/390x160x92`. Без Ё в c36 ОК.
- r44 SKU43 ART 647442350 **Lavezzini Mini Mini** полуавтомат безкамерный (432 chars): c5←c7 «Вакуумный упаковщик Lavezzini Mini Mini»; c36 ← RU body inline `<ul>` 6 li (20л/мин/планка 350/0,25кВт/220В/370x260x130/13кг). Сохранены: «гофрированные пакеты» (без UA `&#39;` от «Під'єднання» → «Подключение»), «нержавеющая сталь», «сухие продукты», «автоматическое выключение». Без Ё ОК.
- r45 SKU44 ART 647442351 **Lavezzini Optima** камерный 10 м3/час (677 chars): c5←c7 «Вакуумный упаковщик Lavezzini Optima»; c36 ← RU body inline `<ul>` 7 li (10м3/час/планка 350/камера 360х400x190/220В/0,45кВт/530х420х400/40кг). Сохранены ключевые фичи: «полуавтоматический камерный», «цифровая панель управления», «обычное+быстрое вакуумирование», «нержавеющая сталь», «влагозащитная панель», «съёмная сварочная планка», «два уровня высоты», «вставки для поднятия уровня продукта», «упаковка жидких», «инертный газ», «гладкие пакеты». UA «Під'єднання» → «Подключение». Без Ё ОК.
- r46 SKU45 ART 647442352 **Lavezzini Unica** камерный 12 м3/час (674 chars): c5←c7 «Вакуумный упаковщик Lavezzini Unica»; c36 ← RU body identical template to r45 с увеличенными dims (12м3/час/планка 400/камера 410х450x220/220В/0,9кВт/550х470х430/55кг). Источник пропустил точку после «гладкі пакеты» перед `<ul>` — сохраняем структурный typo (без точки). Без Ё ОК.
- r48 SKU47 ART 878084280 **Lavezzini Universal** камерный + внешнее вакуумирование (866 chars): c5←c7 «Вакуумный упаковщик Lavezzini Universal»; c36 ← RU body `<p>+<p>+<ul>` 8 li (6м3/час/гладкие пакеты для внутреннего вакуумирования/планка 300/камера 310х350x120/220В/0,35кВт/530х370х250/32кг). Дополнительный 2-й `<p>`: «Дополнительный режим внешнего вакуумирования для крупных продуктов (с помощью перфорированных продуктов).» (UA источник «з допомогою перфорованих продуктів» — структурно странно, но сохраняем faithful). Без Ё ОК.
- r49 SKU48 ART 916970592 **Lavezzini Gofer 150x350 пакеты гофрированные** (148 chars): c5 source UA «Пакет Lavezzini Gofer 150x350 (пакунок)» с UA «пакунок» → c5←c7 «Пакеты гофрированные Lavezzini 150x350 (упаковка 100 шт.)» — same template as r30. c36 ← RU body `<p>` + 3 li (100шт/полиэтилен/150х350). Без Ё ОК.

**SKIP-НП (1) — HURAKAN forward-only:**
- r47 SKU46 ART 732719290 **HURAKAN HKN-VAC400** вакуумный 20 м3/час: brand HURAKAN ∈ SKIP-НП list → forward-only, fixed строка НЕ тронута. c5/c35/c36 source содержат UA «Вакуумний пакувальник», «м3 / год» — НЕ переписываем.

**OQ:** 0.

**Cum после b6:** TRIP 17 + blknotrip 0 + blknochg 25 + SKIP-НП 6 = **48/61**. Next b7 (SKU 49-56, rows 50-57).

## b7 (SKU 49-56, rows 50-57) — DONE 56/61

TRIP 7 + blknotrip 0 + blknochg 0 + SKIP-НП 1 = 8/8. Verify **245 PASS / 0 FAIL**.

**TRIP (7):**
- r50 SKU49 ART 916971482 **Lavezzini Gofer 250x350 пакеты гофрированные** (148 chars): c5 source UA «Пакет Lavezzini Gofer 250x350 (пакунок)» → c5←c7 «Пакеты гофрированные Lavezzini 250x350 (упаковка 100 шт.)». c36 ← RU body `<p>` + 3 li (100шт/полиэтилен/250х350). Без Ё ОК. Same template как r30/r49.
- r51 SKU50 ART 916972344 **Lavezzini Gofer 300x400 пакеты гофрированные** (148 chars): same template как r50 с dims 300х400. c5←c7; c36 ← RU body. Без Ё ОК.
- r52 SKU51 ART 916973058 **Lavezzini Smooth 300x400 пакеты гладкие** (145 chars): c5 source UA «Пакети гладкі Lavezzini Smooth 300x400 (пачка 100 шт.)» → c5←c7 «Пакеты гладкие Lavezzini Smooth 300x400 (упаковка 100 шт.)». c36 ← RU body `<p>` + 3 li (100шт/полиэтилен/300х400) — гладкий вариант, отличается от гофрированного только словом «гладкие/гладкі». Без Ё ОК.
- r53 SKU52 ART 1171045019 **REEDNEE DZ260** вакуумный упаковщик камерный (544 chars): c5 source UA «Пакувальник вакуумний REEDNEE DZ260» → c5←c7 «Упаковщик вакуумный REEDNEE DZ260». c36 ← RU body `<h2>` + `<p>` + `<ul>` 8 li tech-char (385х280х50/планка 260/10м3/час/0,37кВт/502х330х380). Сохранены: полуавтоматический, настольный, электронная панель управления, гладкие пакеты, влагосодержащий продукт, резиновые ножки, прозрачная крышка на уплотнителе. UA «вакумації» (typo в источнике, должно быть «вакуумації») → переведено как «вакуумирования». Без Ё ОК.
- r55 SKU54 ART 1238245270 **REEDNEE DZ400** вакуумный упаковщик камерный (576 chars): same template как r53 с увеличенными dims. +1 дополнительный li «одна сварочная планка». c5←c7 «Упаковщик вакуумный REEDNEE DZ400». c36 ← RU body 9 li (440х420х70/планка 390/20м3/час/0,9кВт/540х490х500). Без Ё ОК.
- r56 SKU55 ART 1581264554 **FROSTY VM300TE/A** вакууматор (918 chars): c5 source RU «Вакууматор FROSTY VM300TE/A» (c4==c5==c7 одинаковые, c5 unchanged — уже корректно). c36 ← RU body `<h2>` + `<p>` + `<ul>` 14 li tech-char (10 куб.м/час/300х405х50+55h/шов 260x8/цикл 10-20с/0,4кВт/220В/370x510x370). Сохранены: нержавеющая сталь, цельнотянутая конструкция без швов, округленные углы (без Ё «округленными»), куполообразная крышка, газовые амортизаторы, утолщенный плексиглас (без Ё «утолщенного»), цифровой дисплей+механический манометр, 10 программ, TOOL KIT латиницей, протиСкользящие ножки. Без Ё ОК.
- r57 SKU56 ART 1581275926 **FROSTY VM400TE/A** вакууматор (955 chars): same template как r56 с увеличенными dims + 1 дополнительный li «1 запаечная планка». c5 unchanged (RU OK). c36 ← RU body 15 li (20 куб.м/час/430х430х75+55h/шов 400x10/цикл 10-25с/0,9кВт/220В/480x530x470). HTML entity `&mdash;` сохранён. Без Ё ОК.

**SKIP-НП (1) — Hurakan forward-only:**
- r54 SKU53 ART 1176134094 **Hurakan HKN-VAC260** (260 мм планка): brand Hurakan ∈ SKIP-НП list → forward-only, fixed строка НЕ тронута. c5/c35/c36 source содержат UA «Вакуумний пакувальник Hurakan HKN-VAC260, 260 мм планка» — НЕ переписываем.
