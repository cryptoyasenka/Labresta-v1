...
**Status:** b11 DONE 85/85 — chunk-064 ЗАКРЫТ (b1-b11 по 8 SKU)
...
**blk триплет (4):**
- SKU53 r54 HENDI 211106 — col5→c7 «Чаероздатчик HENDI 211106, 6л , двойная стенка» (genuine RU verbatim); col36→faithful RU перевод UA-тела (skel==c35, dims==c35, «85°С»/«90°С» кир.С verbatim).
- SKU54 r55 HENDI 211205 — col5→c7 «Кипятильник – кофеварочная машина HENDI 211205, 10 л , двойная стенка» (en-dash U+2013 verbatim); col36→faithful RU (skel==c35, «+85°С»/«+90°С» кир.С).
- SKU55 r56 HENDI 211502 — col5→c7 «Кипятильник HENDI 211502, 18 л, двойная стенка»; col36→faithful RU (skel==c35, «100°C» лат.C verbatim).
- SKU56 r57 FROSTY WBF-10 — col5→c7 «Кипятильник FROSTY WBF-10 (10 л)»; col36→faithful RU (`\n`-структура + em-dash «—» verbatim, «+110 °C» лат.C, skel==c35).

**blknotrip (0):** нет.

**blknochg (4):** SKU49 GGM WKH30 / SKU50 GoodFood WB15A / SKU51 GoodFood WB20A / SKU52 GoodFood WB10A — c5==c7 genuine RU, c35!=c36 (c36 уже переведён), fixed НЕ тронут==src.

**SKIP-НП (0):** нет.

**Verify:** 141 PASS / 0 FAIL.

## b8 (SKU 57-64, rows 58-65)

**blk триплет (8):**
- SKU57 r58 FROSTY WBF-15 — col5→c7 «Кипятильник FROSTY WBF-15 (14 л)» (genuine RU verbatim); col36→faithful RU перевод UA-тела (skel==c35, dims==c35, «+110 °C» лат.C U+0043 verbatim).
- SKU58 r59 FROSTY WBF-30 — col5→c7 «Кипятильник FROSTY WBF-30 (21 л)»; col36→faithful RU (skel==c35, dims==c35, «+110 °C» лат.C).
- SKU59 r60 FROSTY FWBD-08B — col5→c7 «Кипятильник двухстенный FROSTY FWBD-08B (7,2 л)»; col36→faithful RU (skel==c35, «+100 °C» лат.C).
- SKU60 r61 FROSTY FWBD-16B — col5→c7 «Кипятильник двухстеночный FROSTY FWBD-16B (14,5 л)»; col36→faithful RU (skel==c35, «+100 °C» лат.C).
- SKU61 r62 HENDI 211168 — col5→c7 «Кипятильник-заварочная машина с двойными стенками HENDI 10 л 211168»; col36→faithful RU (skel==c35, dims==c35, «30°C»/«100°C» лат.C, «310х330х455» кир.х U+0445, ТЕН→ТЭН).
- SKU62 r63 HENDI 211175 — col5→c7 «Кипятильник-заварочная машина с двойными стенками HENDI 20 л 211175»; col36→faithful RU (skel==c35, `&deg;C` энтити + `&laquo;`/`&raquo;` verbatim, «360x380» лат.x, `&#39;` снят).
- SKU63 r64 HENDI 211137 — col5→c7 «Кипятильник-заварочная машина с одинарными стенками HENDI 10 л 211137»; col36→faithful RU (skel==c35, «30°C»/«100°C» лат.C, «310х330х455» кир.х).
- SKU64 r65 HENDI 211144 — col5→c7 «Кипятильник с одинарными стенками, 20 л 211144»; col36→faithful RU (skel==c35, лид `<p> ` ведущий пробел verbatim, «400х420х475» кир.х).

**blknotrip (0):** нет.

**blknochg (0):** нет.

**SKIP-НП (0):** нет (бренды FROSTY/HENDI не НП-эксклюзивные).

**Verify:** 149 PASS / 0 FAIL.

## b9 (SKU 65-72, rows 66-73)

**blk триплет (2):**
- SKU65 r66 HENDI 211151 — col5→c7 «Кипятильник Hendi 211151 30 л с одинарными стенками,» (genuine RU verbatim); col36→faithful RU перевод UA-тела (skel==c35, dims==c35; тело mixed UA li1-3 / RU li4-11 → col36 целиком RU; «30°C»/«100°C» лат.C, «400x420x(H)610» лат.x, ведущий `<p> ` пробел verbatim).
- SKU66 r67 FROSTY FWBD-25B — col5→c7 «Кипятильник двухстеночный FROSTY FWBD-25B (22,8 л)» (genuine RU verbatim); col36→faithful RU перевод UA-тела (skel==c35, dims==c35; «+100°C» лат.C, «корпус — нержавеющая сталь» em-dash U+2014 verbatim).

**blknotrip (0):** нет.

**blknochg (6):** SKU67 r68 SARO ANCONA 5 / SKU68 r69 SARO ANCONA 10 / SKU69 r70 SARO ANCONA 30 / SKU70 r71 SARO Hot drink mini / SKU71 r72 SARO Hot drink (20 л) / SKU72 r73 SARO Hot drink maxi — c5==c7 genuine RU, c35!=c36 (c36 уже корректный RU перевод), fixed НЕ тронут. Soft-note pre-existing: «Обьем» ь-вместо-ъ; SKU69 «температуры.Нагреватель» без пробела; c36 `30 &deg; -110 &deg; C` энтити vs UA `30 ° -110 °C` литерал.

**SKIP-НП (0):** нет (бренды HENDI/FROSTY/SARO не НП-эксклюзивные).

**Verify:** 157 PASS / 0 FAIL.
...
**SKIP-НП (8): NP-эксклюзивный бренд — fixed НЕ тронут**
- SKU73 r74 ART 1168724439 — HURAKAN HKN-HVZ35M. SKIP-НП (brand=HURAKAN, тело из фида НП позже); fixed row74 НЕ тронут (col5/col36 как в источнике).
- SKU74 r75 ART 1336654011 — HURAKAN HKN-HVB15. SKIP-НП (brand=HURAKAN, тело из фида НП позже); fixed row75 НЕ тронут (col5/col36 как в источнике).
- SKU75 r76 ART 1336655588 — HURAKAN HKN-HVZ25M. SKIP-НП (brand=HURAKAN, тело из фида НП позже); fixed row76 НЕ тронут (col5/col36 как в источнике).
- SKU76 r77 ART 1485281695 — HURAKAN HKN-HVB8. SKIP-НП (brand=HURAKAN, тело из фида НП позже); fixed row77 НЕ тронут (col5/col36 как в источнике). _c5≠c7 (c5 уже частичный RU «Кип'ятильник Hurakan…з подвійними стінками») — всё равно SKIP-НП, brand priority._
- SKU77 r78 ART 1485285952 — HURAKAN HKN-HVB12. SKIP-НП (brand=HURAKAN, тело из фида НП позже); fixed row78 НЕ тронут (col5/col36 как в источнике).
- SKU78 r79 ART 1485946760 — HURAKAN HKN-HVB20. SKIP-НП (brand=HURAKAN, тело из фида НП позже); fixed row79 НЕ тронут (col5/col36 как в источнике). _c5≠c7 — всё равно SKIP-НП, brand priority._
- SKU79 r80 ART 1485952587 — HURAKAN HKN-HVB25. SKIP-НП (brand=HURAKAN, тело из фида НП позже); fixed row80 НЕ тронут (col5/col36 как в источнике). _c5≠c7 — всё равно SKIP-НП, brand priority._
- SKU80 r81 ART 1485970635 — HURAKAN HKN-HVB30. SKIP-НП (brand=HURAKAN, тело из фида НП позже); fixed row81 НЕ тронут (col5/col36 как в источнике). _c5≠c7 — всё равно SKIP-НП, brand priority._

**Verify:** 165 PASS / 0 FAIL.

## b11 (SKU 81-85, rows 82-86)

**blk триплет (3):**
- SKU81 r82 ART 1532686297 EWT INOX WB16E1 — col5→c7 «Электрокипятильник 16 л EWT INOX WB16E1» (genuine RU verbatim); col36→faithful RU перевод UA-тела (skel==c35, dims==c35; «30-100 &deg; С» пробел+кир.С U+0421, «220 В»/«1,5 кВт» кир.В U+0412, INOX/WB16E1 лат.X/B, об'єм→объем UA-clean).
- SKU83 r84 ART 1924220284 HENDI 211403 — col5→c7 «Кипятильник-заварочная машина с двойными стенками HENDI 9 л 211403» (genuine RU verbatim); col36→faithful RU перевод UA-тела (skel==c35, dims==c35; «+100&deg;C» лат.C U+0043 без пробела, «241х480» кир.х U+0445 verbatim).
- SKU84 r85 ART 2044598468 FROSTY FWD-30K1 — col5→c7 «Кипятильник Frosty FWD-30K1» (genuine RU verbatim); col36→faithful RU перевод UA-тела (skel==c35, dims==c35; 5×`&deg;` mixed лат.C/кир.С U+0421 по codepoint-дампу, «FROSTY - це» дефис U+002D с пробелами verbatim, «G1/2» verbatim).

**blknotrip (0):** нет.

**blknochg (1):** SKU82 r83 ART 1577286284 AIRHOT WB-15 — c5==c7 genuine RU, c35!=c36 (c36 уже корректный RU перевод), fixed НЕ тронут.

**SKIP-НП (1):** SKU85 r86 ART 2060623567 — HURAKAN HKN-HVN20. SKIP-НП (brand=HURAKAN, тело из фида НП позже); fixed row86 НЕ тронут (col5/col36 как в источнике).

**Verify:** 170 PASS / 0 FAIL.

**chunk-064 ЗАКРЫТ: 85/85 (b1..b11). Открытых вопросов 0.**
