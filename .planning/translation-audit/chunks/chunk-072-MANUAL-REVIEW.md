...
**Категории:** TRIP 1 (Hendi 580226 весы кухонные) + blknochg 7 (массивный блок суши-оборудования: 4× SUZUMO роботы/нож/миксер + Konica Minolta мойка + 2× FUJIMAK мойка/рисоварка).

**TRIP detail:**
- **r81 Hendi 580226 весы кухонные** — до 5 кг ±1 г, минимальный вес 20 г, поверхность из нержавеющей стали без сварных швов, цифровой дисплей, датчик натяжения высокой точности, единицы граммы/килограммы/унции/фунты, сенсорная панель, авто-сброс/уведомление о перегрузке/низкий заряд, авто-выключение, 2× CR2032, габариты 200х151х11 мм. **Source-quirk: UA `±1 р` (буква 'р' опечатка вместо 'г') → нормализован к RU «±1 г»** (consistent с «20 г» далее в теле).

**blknochg detail:**
- **r74 SUZUMO SVR-NХA-CE** — робот для производства квадратных роллов (нори-маки) трёх видов: толстые (футо-маки), средние (чу-маки), тонкие. c5/c36 RU. **NB:** c4 UA «SVR-NXA» с Latin X, c5/c7/c35/c36 с Cyrillic Х — preserve.
- **r75 SUZUMO SVR-BХA-CE** — робот для производства круглых роллов (нори-маки), ура-маки «Филадельфия»/«Калифорния». То же Latin/Cyrillic X mismatch.
- **r76 SUZUMO SVC-ATC-CE+SVC-AT8FB** — автоматический нож для нарезания роллов, в комплекте с запасным набором, режет на 6 или 8 кусочков.
- **r77 Konica Minolta RM-401AG-CE** — автоматическая мойка для риса с качественной промывкой, бункер для сырого риса, автоматический контроль всех операций.
- **r78 SUZUMO MCR-UNC** — миксер для риса с уникальной технологией смешивания, тщательно обрабатывает каждое зёрнышко в автоматическом режиме.
- **r79 FUJIMAK FRW22W** — мойка для риса с интеллектуальной системой мойки (рис меньше повреждается, высокое давление воды).
- **r80 Fujimak FRC162NC** — рисоварка электрическая на 3 уровня, производительность от 2,8 кг до 15 кг риса за 45 минут, габариты 750х650х1380 мм, тефлоновое покрытие.

**Терминология b10 (новые UA→RU):**
- «Робот для виробництва квадратних/круглих ролів (норі-макі)» → «Робот для производства квадратных/круглых роллов (нори-маки)»
- «футо-макі / чумакі / ура-макі» → «футо-маки / чу-маки / ура-маки»
- «Автоматичний ніж для нарізування ролів» → «Автоматический нож для нарезания роллов»
- «Автоматична мийка для рису» → «Автоматическая мойка для риса»
- «Міксер для рису» → «Миксер для риса»
- «Рисоварка електрична на 3 рівні» → «Рисоварка электрическая на 3 уровня»
- «Ваги кухонні» → «Весы кухонные»
- «Вимірювання ... з точністю ±1 г – мінімальна вага 20 г» → «Измерение ... с точностью ±1 г — минимальный вес 20 г»
- «Поверхня з нержавіючої сталі без зварних швів» → «Поверхность из нержавеющей стали без сварных швов»
- «Датчик натягу високої точності» → «Датчик натяжения высокой точности»
- «Одиниці виміру ваги: грами, кілограми, унції або фунти» → «Единицы измерения веса: граммы, килограммы, унции или фунты»
- «Сенсорна панель: включення/вимикання, тара, зміна одиниці виміру» → «Сенсорная панель: включение/выключение, тара, смена единицы измерения»
- «Автоматичний скидання, повідомлення про перевантаження» → «Автоматический сброс, уведомление о перегрузке»
- «Харчування: 2 батарейки CR2032» → «Питание: 2 батарейки CR2032»

**Открытые вопросы b10:** 0 новых.
**Source-quirks preserved/нормализованы в b10:**
- r74/r75 c4 UA Latin X vs c5/c7/c35/c36 Cyrillic Х в коде модели SVR-NXA / SVR-BXA — preserve as is (blknochg)
- r81 UA `±1 р` typo → нормализовано к RU `±1 г` (TRIP, write-side)

**Iframes preserved:** нет (b10 без iframe).
...
**Категории b11:**
- TRIP 2 (r82 весы Hendi 580233, r87 стиральная WHIRLPOOL AWH 912S/PRO)
- blknochg 5 (r84/85/86/88/89 WHIRLPOOL стиральные/сушильные)
- SKIP-НП 1 (r83 FAGOR SCP-10 M E 1P COMPACT CONCEPT сушильная — forward-only)

**Карточки b11 (RU краткое описание):**
- **r82 Hendi 580233** — весы кухонные до 15 000 г, точность ±1 г, мин 2 г, нерж+HIPS, датчик натяжения, граммы, авто-выключение, 3 AAA, 266x269x(H)34 мм.
- **r83 FAGOR SCP-10 M E 1P COMPACT CONCEPT** — SKIP-НП (бренд FAGOR ∈ exclusive list); тело будет из фида НП.
- **r84 WHIRLPOOL** — стиральная (blknochg, c5/c36 уже RU).
- **r85 WHIRLPOOL** — стиральная (blknochg).
- **r86 WHIRLPOOL** — стиральная (blknochg).
- **r87 WHIRLPOOL AWH 912 S/PRO** — профессиональная стиральная машина 9 кг с пропариванием. Технология ZEN (прямой привод инверторный), 6th Sense (-45% энергии), функция ОБРАБОТКА ПАРОМ (-99,9% бактерий), G-фактор 390, отжим 1200 об/мин, 24 программы, 1700 Вт, 599х643х845 мм.
- **r88 WHIRLPOOL** — сушильная (blknochg).
- **r89 WHIRLPOOL** — сушильная (blknochg).

**Терминология b11 (новые UA→RU):**
- «Ваги кухонні» → «Весы кухонные» (продолжение b10, но другая модель/предел)
- «Точне зважування» → «Точное взвешивание»
- «з вбудованим дисплеєм» → «со встроенным дисплеем»
- «полістиролу» → «полистирола»
- «обладнаний датчиком натягу високої точності» → «датчик натяжения высокой точности» (b10 имел «натягу», тут продолжение)
- «Професійна пральна машина» → «Профессиональная стиральная машина»
- «функцією обробки парою» → «функцией обработки паром» / «функция ОБРАБОТКА ПАРОМ»
- «ременевий привід» → «ременной привод»
- «інверторний двигун з прямим приводом» → «инверторный двигатель с прямым приводом»
- «Технологія 6th Sense» → «Технология 6th Sense» (source `Sence` → корректный `Sense`)
- «G-фактор» → «G-фактор» (термин сохраняется)
- «залишкова вологість» → «остаточная влажность»
- «знищує до 99,9% найпоширеніших бактерій» → «удаляет до 99,9% наиболее распространенных бактерий»

**Открытые вопросы b11:** 0 новых.

**Source-quirks preserved/нормализованы в b11:**
- r87 c5 typo «фунцкцией» (вместо «функцией») — preserve verbatim (c5==c7 source equality, не редактируется)
- r87 c35 UA «6th Sence» typo → нормализовано к «6th Sense» (TRIP write-side в c36)
