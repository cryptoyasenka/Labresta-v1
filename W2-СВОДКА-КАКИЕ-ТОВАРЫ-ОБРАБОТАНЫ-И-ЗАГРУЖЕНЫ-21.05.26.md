...
> **UPDATE 2026-05-21 (post-import):** добавлена секция 12 в основном handoff — Issue #1 ("хенди" кириллицей в описании 4 Hendi-тендерайзеров) **RESOLVED**: patched lead-paragraph + patch-bundle 4 SKU готов к импорту (`.planning/translation-audit/w2-horoshop-import-PATCH-hendi-lead.xlsx`). Forward UA фикс к W1.
